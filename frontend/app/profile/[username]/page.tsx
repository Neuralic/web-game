...
const ProfilePage = () => {
  ...
  // Fetch social links and setup real-time updates
  useEffect(() => {
    ...
    // Setup real-time subscription for social links changes
    if (!profileUser?.id) return;
    ...
    const channel = supabase
      ...
      .on(
        ...
        () => {
          // Refetch social links when they change
          fetchSocialLinks();
        }
      )
      .subscribe();
                          ...
                          {relationship?.isFriend ? (
                            ...
                            <>
                              ...
                              <button 
                                ...
                                className="px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-gray-100 font-medium rounded-lg text-sm transition-colors disabled:opacity-50"
                              >
                                Unfriend
                              </button>
                            </>
                      ...
                      {socialLinks.map((link) => (
                        ...
                        >
                          ...
                          {link.platform === 'github' && (
                            <svg className="w-6 h-6 text-gray-900 dark:text-gray-100" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          {!['youtube', 'twitter', 'twitch', 'discord', 'github'].includes(link.platform) && (
