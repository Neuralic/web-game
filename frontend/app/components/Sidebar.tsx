          ...
          <>
            ...
            <div className="px-4 py-3 flex flex-col gap-2">
              ...
              <Link
                href="/groups/merge"
                onClick={onClose}
                className="block w-full bg-gray-100 dark:bg-[#1a1a1a] hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold py-2.5 text-sm rounded-lg transition-colors text-center border border-gray-200 dark:border-[#2a2a2a]"
              >
                Merge Roblox Group
              </Link>
            </div>
